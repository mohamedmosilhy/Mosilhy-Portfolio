...
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-space-2 whitespace-nowrap rounded-md border border-transparent font-medium text-label outline-none transition-[color,background-color,border-color,box-shadow,transform] duration-[var(--motion-fast)] ease-[var(--ease-standard)] focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-canvas disabled:pointer-events-none disabled:translate-y-0 disabled:cursor-not-allowed disabled:text-text-muted disabled:opacity-100 aria-disabled:pointer-events-none aria-disabled:translate-y-0 aria-disabled:cursor-not-allowed aria-disabled:text-text-muted aria-disabled:opacity-100 [&>svg]:pointer-events-none [&>svg]:shrink-0 [&>svg]:stroke-[1.75] motion-reduce:transform-none motion-reduce:transition-[color,background-color,border-color]",
  {
    variants: {
      variant: {
        primary:
