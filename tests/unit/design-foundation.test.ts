...
describe("design system foundation", () => {
  ...
  it("encodes the documented type, spacing, shape, depth, and layout scales", () => {
    expect(Object.fromEntries(properties)).toMatchObject({
      "--display-xl": "clamp(4rem, 8.5vw, 7.5rem)",
      "--display-xl-line-height": "0.9",
      "--display-xl-tracking": "-0.05em",
      "--display-lg": "clamp(3.25rem, 6.5vw, 5.75rem)",
      "--display-lg-line-height": "0.94",
      "--display-lg-tracking": "-0.045em",
      "--heading-xl": "clamp(2.625rem, 4.75vw, 4.25rem)",
      "--heading-xl-line-height": "1",
      "--heading-xl-tracking": "-0.04em",
      "--heading-lg": "clamp(2rem, 3vw, 3rem)",
      "--heading-lg-line-height": "1.08",
      "--heading-lg-tracking": "-0.03em",
      "--heading-md": "clamp(1.5rem, 2vw, 2rem)",
      "--heading-md-line-height": "1.15",
      "--heading-md-tracking": "-0.025em",
      "--heading-sm": "1.25rem",
      "--heading-sm-line-height": "1.25",
      "--heading-sm-tracking": "-0.015em",
